...
function ServiceCard({ service, index }: { service: typeof services[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="card-hover group bg-[#111] border border-white/5 rounded-xl p-6 relative overflow-hidden"
    >
      {/* Hover accent line */}
      ...
      {/* Spinning wheel decorative element */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-gray-500 max-w-xl mx-auto">
            From minor dents to major collisions — we handle it all with the highest quality materials and craftsmanship.
          </p>
        </motion.div>
        ...
        >
          <a
            href="/booking"
            className="inline-flex items-center gap-2 text-gray-400 hover:text-white text-sm border border-white/10 hover:border-red-500/40 px-6 py-3 rounded-lg transition-all duration-300"
          >
            Get a Free Estimate →
          </a>
        </motion.div>
