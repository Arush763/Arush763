    ...
    <section className="py-24 bg-[#0d0d0d] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative" ref={ref}>
        ...
        >
          ...
          <p className="text-gray-500 max-w-xl mx-auto mb-10">Reservations are quick and easy. Choose your service, pick a time, and we’ll take it from there.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/booking" className="inline-flex items-center gap-3 bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold px-8 py-4 rounded-lg text-lg shadow-xl shadow-red-900/40 hover:scale-105 hover:shadow-red-900/60 transition-all duration-300">
              <Calendar className="w-5 h-5" />Book a Reservation
            </Link>
            <a href="tel:+15555555555" className="inline-flex items-center gap-3 text-gray-300 hover:text-white border border-white/10 hover:border-white/30 px-8 py-4 rounded-lg text-lg font-medium transition-all duration-300 hover:bg-white/5">
              <Phone className="w-5 h-5 text-red-500" />Call Us Now
            </a>
          </div>
        </motion.div>
      </div>
