      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Honest, quality autobody repair done right. Serving our community with pride since 2010.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Services', 'Gallery', 'About', 'Book Now', 'Admin'].map((item) => (
                <li key={item}>
                  <Link
                    href={item === 'Book Now' ? '/booking' : item === 'Admin' ? '/admin' : `/#${item.toLowerCase()}`}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-gray-500">
                ...
                123 Auto Lane, Your City, ST 00000
              </li>
              ...
              <li className="flex items-center gap-3 text-sm text-gray-500">
                ...
                <a href="mailto:info@reshineauto.com" className="hover:text-white transition-colors">info@reshineauto.com</a>
              </li>
              <li className="flex items-start gap-3 text-sm text-gray-500">
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-600 text-xs">
            &copy; {new Date().getFullYear()} Reshine Auto Works. All rights reserved.
          </p>
