  ...
  return (
    <div
      ...
      style={{
        ...
        width: size,
        height: size,
        background: `radial-gradient(circle at 30% 30%, rgba(192,57,43,0.4), rgba(230,126,34,0.15))`,
        animation: `float-bubble ${8 + delay}s ease-in ${delay}s infinite`,
...
/* Road line */
function RoadLine({ delay, left }: { delay: number; left: number }) {
  return (
    <motion.div
      className="absolute bottom-14 h-0.5 bg-gradient-to-r from-transparent via-red-600/40 to-transparent"
      style={{ left: `${left}%`, width: '80px' }}
      animate={{ x: [-200, window?.innerWidth + 200 || 1600] }}
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-red-600/10 border border-red-600/20 rounded-full px-4 py-1.5 mb-8"
        >
        ...
        >
          ...
          <span className="text-gradient">RESTORE</span>
          <br />
        ...
        >
          Reshine Auto Works delivers expert collision repair, flawless paint jobs, and honest service.
        ...
        >
          <Link
            href="/booking"
            className="relative overflow-hidden inline-flex items-center gap-2 bg-gradient-to-r from-red-600 to-orange-500 text-white font-bold px-8 py-4 rounded-lg text-lg shadow-lg shadow-red-900/40 hover:shadow-red-900/60 hover:scale-105 transition-all duration-300 group"
          >
          ...
          <Link
            href="/#gallery"
            className="inline-flex items-center gap-2 text-gray-300 hover:text-white border border-white/10 hover:border-white/30 px-8 py-4 rounded-lg text-lg font-medium transition-all duration-300 hover:bg-white/5"
          >
            View Our Work
          </Link>
        </motion.div>
